...
public class BController {
	...
	public String write(HttpServletRequest request, Model model) {
		...
		System.out.println("BWriteCommand³ª¿È");
		command.execute(model);
		System.out.println("BWriteCommand executeÈÄ");
	...
	@RequestMapping(method = {RequestMethod.POST,RequestMethod.GET}, value = "/reply_view")
